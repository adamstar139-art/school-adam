...
# =========================================================
st.set_page_config(
    page_title="نظام رصد الدرجات والمزامنة المزدوجة",
    page_icon="🎓",
    layout="wide",
...
SPREADSHEET_URL = "https://docs.google.com/spreadsheets/d/YOUR_SPREADSHEET_ID/edit" # استبدل برابط شيت جوجل الخاص بك
...
def get_gsheet_worksheet():
    ...
    # 1. المحاولة الأولى: Streamlit Secrets
    ...
    # 2. المحاولة الثانية: ملف service_account.json
...
# =========================================================
# 2. قواعد البيانات والبيانات الأولية
# =========================================================
RAW_EXCEL_STUDENTS = [
    ...
    {'grade': 'الصف الأول المتوسط', 'class': 'فصل 101', 'seq': 4, 'name': 'ريان عبد الله جابر الأسمري', 'science': 4.0, 'math': 7.0, 'lughati': 6.0, 'english': 3.0},
    {'grade': 'الصف الأول المتوسط', 'class': 'فصل 101', 'seq': 5, 'name': 'زيد زياد عبد اللطيف أبو قبع', 'science': 6.0, 'math': 0.0, 'lughati': 5.0, 'english': 6.0},
    {'grade': 'الصف الأول المتوسط', 'class': 'فصل 101', 'seq': 6, 'name': 'سامي سعد عباس حمد', 'science': 3.0, 'math': 0.0, 'lughati': 6.0, 'english': 5.0},
    {'grade': 'الصف الأول المتوسط', 'class': 'فصل 101', 'seq': 7, 'name': 'سعد ناصر سعد السيف', 'science': 3.0, 'math': 0.0, 'lughati': 2.0, 'english': 4.0},
    {'grade': 'الصف الأول المتوسط', 'class': 'فصل 101', 'seq': 8, 'name': 'عبد الله بن سليمان بن عبد الله الراجحي', 'science': 0.0, 'math': 0.0, 'lughati': 7.0, 'english': 0.0},
    ...
    {'grade': 'الصف الأول المتوسط', 'class': 'فصل 101', 'seq': 10, 'name': 'علي أحمد علي كريري', 'science': 4.0, 'math': 0.0, 'lughati': 5.0, 'english': 2.0},
    {'grade': 'الصف الأول المتوسط', 'class': 'فصل 101', 'seq': 11, 'name': 'علي سعد علي القحطاني', 'science': 3.0, 'math': 0.0, 'lughati': 3.0, 'english': 4.0},
    {'grade': 'الصف الأول المتوسط', 'class': 'فصل 101', 'seq': 12, 'name': 'عمر عبد الله سعد الجبرين', 'science': 2.0, 'math': 0.0, 'lughati': 1.0, 'english': 4.0},
    {'grade': 'الصف الأول المتوسط', 'class': 'فصل 101', 'seq': 13, 'name': 'مازن إسلام أحمد إبراهيم موسى', 'science': 4.0, 'math': 0.0, 'lughati': 5.0, 'english': 5.0},
    {'grade': 'الصف الأول المتوسط', 'class': 'فصل 101', 'seq': 14, 'name': 'محمد أحمد علي عقيل', 'science': 0.0, 'math': 0.0, 'lughati': 0.0, 'english': 0.0},
    {'grade': 'الصف الأول المتوسط', 'class': 'فصل 101', 'seq': 15, 'name': 'محمد إسلام محمد دراز', 'science': 4.0, 'math': 0.0, 'lughati': 5.0, 'english': 6.0},
    {'grade': 'الصف الأول المتوسط', 'class': 'فصل 101', 'seq': 16, 'name': 'محمد أشرف مسعود أبو خاطر', 'science': 4.0, 'math': 0.0, 'lughati': 5.0, 'english': 6.0},
    {'grade': 'الصف الأول المتوسط', 'class': 'فصل 101', 'seq': 17, 'name': 'محمد نايف فراج الدعجاني', 'science': 0.0, 'math': 0.0, 'lughati': 3.0, 'english': 0.0},
    {'grade': 'الصف الأول المتوسط', 'class': 'فصل 101', 'seq': 18, 'name': 'وائل بولعيش', 'science': 0.0, 'math': 0.0, 'lughati': 0.0, 'english': 5.0},
    ...
    {'grade': 'الصف الأول المتوسط', 'class': 'فصل 102', 'seq': 2, 'name': 'الوليد ابن خالد بن فهد العتيبي', 'science': 5.0, 'math': 0.0, 'lughati': 6.0, 'english': 9.0},
    {'grade': 'الصف الأول المتوسط', 'class': 'فصل 102', 'seq': 3, 'name': 'باسل محمد فرج الدوسري', 'science': 6.0, 'math': 0.0, 'lughati': 7.0, 'english': 4.0},
    {'grade': 'الصف الأول المتوسط', 'class': 'فصل 102', 'seq': 4, 'name': 'بسام بن عبد الكريم بن عبد الله الحرقان الدوسري', 'science': 4.0, 'math': 0.0, 'lughati': 3.0, 'english': 0.0},
    {'grade': 'الصف الأول المتوسط', 'class': 'فصل 102', 'seq': 5, 'name': 'تركي عبد الله مسفر الدوسري', 'science': 5.0, 'math': 0.0, 'lughati': 5.0, 'english': 4.0},
    {'grade': 'الصف الأول المتوسط', 'class': 'فصل 102', 'seq': 6, 'name': 'تميم فهد عبد العزيز العزاز', 'science': 3.0, 'math': 0.0, 'lughati': 5.0, 'english': 3.0},
    {'grade': 'الصف الأول المتوسط', 'class': 'فصل 102', 'seq': 7, 'name': 'راكان عبد الله يحيى كريري', 'science': 5.0, 'math': 0.0, 'lughati': 6.0, 'english': 6.0},
    {'grade': 'الصف الأول المتوسط', 'class': 'فصل 102', 'seq': 8, 'name': 'ريان عبد الله منصور السبر', 'science': 7.0, 'math': 0.0, 'lughati': 9.0, 'english': 6.0},
...
def init_db(force=False):
    """إنشاء وتعبئة قاعدة البيانات المحلية SQLite"""
...
# تشغيل التهيئة عند بدء البرنامج
init_db()
...
def update_student_scores(edited_df):
    """تحديث الدرجات المعدلة في الجدول التفاعلي"""
    conn = sqlite3.connect(DB_FILE)
    c = conn.cursor()
...
def export_to_excel_bytes(df):
    """تحويل DataFrame إلى ملف Excel كـ Bytes"""
    output = io.BytesIO()
...
# ---------------------------------------------------------
# دوال المزامنة المحدثة مع Google Sheets (الحل المكتمل)
# ---------------------------------------------------------
def sync_db_to_gsheets():
    """رفع البيانات من SQLite المحلي إلى Google Sheets بعد تحويل أسماء الأعمدة للعربية"""
    try:
        ...
        # إعادة تسمية الأعمدة للمسميات العربية وتنسيق الترتيب
        ...
        return True, f"✅ تمت المزامنة والرفع بنجاح! تم رفع {len(data_rows)} سجلاً بأعمدة باللغة العربية."
    except Exception as e:
        return False, f"❌ حدث خطأ أثناء المزامنة مع Google Sheets: {str(e)}"

def sync_gsheets_to_db_reverse():
    """سحب البيانات من Google Sheets وتحديث قاعدة البيانات المحلية SQLite"""
    try:
        ws = get_gsheet_worksheet()
        if ws is None:
            return False, "❌ لم يتم الاتصال بـ Google Sheets."
        ...
        # التحقق من وجود الأعمدة العربية المطلوبة
        missing_cols = [col for col in ARABIC_COLUMNS_ORDER if col not in df_gsheet.columns]
        if missing_cols:
            return False, f"❌ الأعمدة التالية مفقودة في Google Sheets: {missing_cols}. يرجى التأكد من مطابقة الصف الأول للهيدر العربي."

        # إعادة تسمية الأعمدة إلى المسميات الإنجليزية لقاعدة البيانات
        ...
        return True, f"✅ تمت المزامنة العكسية بنجاح! تم تحديث {updated_count} سجلاً في قاعدة البيانات المحلية."
    except Exception as e:
...
# =========================================================
st.markdown("""
<div style="text-align: center; padding: 10px; background: linear-gradient(135deg, #1e3a8a, #3b82f6); color: white; border-radius: 10px;">
...
<div style="margin-top: 10px; padding: 8px; background-color: #d1fae5; border-right: 5px solid #10b981; border-radius: 5px;">
    ✅ تم التزامن والحفظ الفوري دائمياً (SQLite المحلي ↔ Google Sheets)
</div>
""", unsafe_allow_html=True)
...
# ---------------------------------------------------------
# التبويب الثاني: الرسم البياني والمقارنة بين الفصول
# ---------------------------------------------------------
with tab_charts:
...
with tab_excel:
    ...
    # 1. قسم جديد: اختيار وتصدير اختبار تشخيصي محدد كملف Excel
    ...
    # 2. قسم التصدير الشامل والمزامنة
...
# ---------------------------------------------------------
with tab_add:
    st.subheader("➕ إضافة طالب جديد وإسناد الدرجات له")
